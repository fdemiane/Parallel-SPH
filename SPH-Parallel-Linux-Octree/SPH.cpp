...
int main()
{
  ...
  for (int step = 0; step < 100; step++)
      ...
      for (int i = 0; i < pL; i++)
	{
	  ...
	  particleArray[i].pressure = 0.1f * (particleArray[i].density - 1);//cout << particleArray[i].pressure << endl;
	}
      ...
      for (int i = 0; i < pL; i++)
	{
      ...
      //cout << "pressure: "<<particleArray[0].density << " " << particleArray[0].Fpressure.y << " " << particleArray[0].Fpressure.z<<endl;

      // Compute velocities using LeapFrog integration
